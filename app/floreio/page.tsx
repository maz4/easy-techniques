...
const techniques: Technique[] = [
  {
    id: 68,
    name: "Aú na Coluna",
    video: "https://www.youtube.com/embed/aoN2kCMlzEw",
    badge: "Acrobatic"
  },
  {
    id: 69,
    name: "Macaco",
    video: "https://www.youtube.com/embed/0-gZhanpnvM",
    badge: "Acrobatic"
  },
  { id: 70, name: "S Doblado", badge: "Acrobatic" },
  {
    id: 71,
    name: "Aú sem Mão",
    video: "https://www.youtube.com/embed/saJ8bl4-daE",
    badge: "Acrobatic"
  },
  {
    id: 72,
    name: "Beija Flor",
    video: "https://www.youtube.com/embed/Ng6g2bF6gek",
    badge: "Acrobatic"
  },
  { id: 73, name: "Bananeira", badge: "Acrobatic" }
];

export default function FloreioPage() {
  ...
  const t = useMemo(
    () => ({
      title: { english: "Floreio", japanese: "魅せ技" },
